...
?>
<li id="cp-button-bottoms" class="cp-button"><a title="Copy" aria-label="Copy" onclick="luxeUrlCopy('bottoms');return false;"><i class="ico-link"></i><?php if( $icon_only !== true ): ?><span class="cpname">Copy</span><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?> clipboard-check">-</span><?php endif; ?><?php endif; ?></a></li>
<?php
	}
} ?>
</ul>
