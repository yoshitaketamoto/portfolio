...
?>
<li class="cp-button" style="cursor:not-allowed"><a style="pointer-events:none;cursor:not-allowed" title="Copy" aria-label="Copy"><i class="ico-link"></i><?php if( $icon_only !== true ): ?><span class="cpname">Copy</span><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?> clipboard-check">-</span><?php endif; ?><?php endif; ?></a></li>
<?php
	}
	else {
		$position = $luxe['sns_layout'] === 'tops' ? 'tops' : 'bottoms';
?>
<li id="cp-button-<?php echo $position ?>" class="cp-button"><a title="Copy" aria-label="Copy" onclick="luxeUrlCopy('<?php echo $position ?>');return false;"><i class="ico-link"></i><?php if( $icon_only !== true ): ?><span class="cpname">Copy</span><?php if( $cnt_enable === true ): ?><span class="<?php echo $cls_cnt; ?> clipboard-check">-</span><?php endif; ?><?php endif; ?></a></li>
<?php
	}
} ?>
</ul>
